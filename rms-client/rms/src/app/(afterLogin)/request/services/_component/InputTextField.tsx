...
export default function InputTextField({ value }: InputTextFieldProps) {
    ...
    const createExtensionArray = (id: string, value: string | number) => {
    ...
    const handleChange = (event: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
        ...
        switch (value) {
            ...
            case "SA0001":
                ...
                createExtensionArray(value, Number(newValue));
                break;
            case "TA0001":
            ...
            case "TA0005":
                setTA0005(newValue);
                createExtensionArray(value, newValue);
                break;
            case "TA0007":
                setTA0007(newValue);
                createExtensionArray(value, newValue);
